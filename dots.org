      ...
      (use-package exwm
        ...
        (setq exwm-input-global-keys
              `(
                ...
                ([?\s-q] . aldama/switch-to-previous-buffer)
        ...
        ;; (add-hook 'exwm-mode-hook (lambda () (setq exwm-workspace-minibuffer-position 'bottom)))
        ;; (add-hook 'exwm-mode-hook (lambda () (interactive) (exwm-layout-hide-mode-line)))
...
** Funcions
*** Use ~l~ to behave as expected in dired
   #+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
     (defun aldama/dired-open()
       (interactive)
...
*** Switch to the previous buffer
    ...
    #+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
      (defun aldama/switch-to-previous-buffer ()
...
*** Launch apps
    #+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
      (defun aldama/launch-app (arg)
        (interactive (list (completing-read "Apps: " '("Google-chrome" "Firefox" "Rofi"))))
...
* Regolith
  #+begin_src yaml :tangle ~/.config/regolith/i3/config
