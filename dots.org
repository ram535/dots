...
(use-package evil
  ...
  (:prefix "z"
           ...
           "o" (lambda() (interactive) (vterm-send-string "("))
           "p" (lambda() (interactive) (vterm-send-string ")"))
           "a" (lambda() (interactive) (vterm-send-string "&"))
           "s" (lambda() (interactive) (vterm-send-string "*"))
           "g" (lambda() (interactive) (vterm-send-string "#"))
           "z" (lambda() (interactive) (vterm-send-string "z"))
           "q" (lambda() (interactive) (vterm-send-string "@"))
           "t" (lambda() (interactive) (vterm-send-string "|"))
           "r" (lambda() (interactive) (vterm-send-string "\\"))
           "i" (lambda() (interactive) (vterm-send-string "="))
           "\'" (lambda() (interactive) (vterm-send-string "`"))
           "h" (lambda() (interactive) (vterm-send-string "~"))
           "m" (lambda() (interactive) (vterm-send-string "+"))
           "," (lambda() (interactive) (vterm-send-string "-"))
           "u" (lambda() (interactive) (vterm-send-string "_"))
           "e" (lambda() (interactive) (vterm-send-string "^"))
           "w" (lambda() (interactive) (vterm-send-string "%"))
           "x" (lambda() (interactive) (vterm-send-string "$"))))
#+end_src
...
** Startup programs
#+begin_src lisp
(run-shell-command "kmonad $HOME/.config/kmonad/config.kbd" t)
#+end_src
...
(defalias
  j  (tap-hold-next 150 j \()
  k  (tap-hold-next 150 k \))
  d  (tap-hold-next 150 d [)
  f  (tap-hold-next 150 f ])
  n  (tap-hold-next 150 n {)
  m  (tap-hold-next 150 m })
  r  (tap-next (around r u) [))

(defalias
  ;; sym (tap-hold-next 150 a (layer-toggle syms))
...
(deflayer base
  esc         f1    f2   f3   f4   f5   f6   f7   f8   f9   f10  f11   f12    pause  prnt  ins  del
  `           1     2    3    4    5    6    7    8    9    0    -     =      caps              home
  tab         q     w    e    r    t    y    u    i    o    p    [     ]      ret               pgup
  bspc        @sym  s    d    f    g    h    j    k    l    ;    '     \                        pgdn
  lsft  @ct   z     x    c    v    b    n    m    ,    .    /    rsft         up                end
  lctl        lmet  lalt      spc       ralt cmps rctl                 left   down   rght
  )
