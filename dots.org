...
(use-package prog-mode
  ...
  (:keymaps 'dart-mode-map "<f8>" 'ram/dart)
...
(use-package calibredb
  ...
  (calibredb-root-dir "~/Documents/articles")
...
(use-package elfeed
  ...
  (elfeed-feeds
   '("http://nullprogram.com/feed/"
     ...
     "https://mangaplus.shueisha.co.jp/titles/100034"
     )))
#+end_src
...
(defun ram/dired-open()
  ...
  (cond
   ...
   ((string= ext "epub")
    ;; shell-quote-argument escapes white spaces on the file name
    (async-start-process "Calibre" "ebook-viewer" nil file))
   ((string= ext "rar")
...
#+begin_src elisp
(defun ram/org-toggle-hide-emphasis-markers (&optional arg)
...
** alias
#+begin_src sh
alias dd="~/bin/dart-sdk/bin/dart --enable-experiment=non-nullable"
alias dp="~/bin/dart-sdk/bin/pub"
