...
(use-package evil
  ...
  (:states '(emacs normal motion insert visual)
           "C-c c r k" 'ram/backward-kill-line
           "C-c c v u" 'evil-scroll-up
           "C-c c v d" 'evil-scroll-down
           "C-c c e f" 'forward-char
           "C-c c e b" 'backward-char
           "C-c c e p" 'previous-line
           "C-c c e n" 'next-line
           "C-c c v n" 'evil-first-non-blank
           "C-c c v m" 'evil-last-non-blank
...
(defalias
  ...
  qem (layer-switch quick-access)
  ema (layer-switch emacs)
  sym (layer-switch symbol)
  org (layer-switch org-mode))

;; Returns to the default layer after realizing the hold button
(defalias qs_df (around (layer-toggle quick-symbol) @def))

(defalias nv_df (around (layer-toggle navegation) @def))

;; tap -> symbols layer
;; hold -> quick-symbol layer
(defalias sy_qs (tap-hold-next-release 200 @sym @qs_df))
#+end_src
...
(deflayer default
  ...
  `           1      2    3    4      5    6    7    8    9    0    -     =      bspc              home
  tab         q      w    e    r      t    y    u    i    o    p    [     ]      ret               pgup
  bspc        a      s    d    f      g    h    j    k    l    @hl  '     \                        pgdn
  lsft  C-t   z      x    c    v      b    n    m    @qem .    /    rsft         up                end
  lctl        lmet   lalt      spc         ralt cmps rctl                 left   down   rght
  )
#+end_src
...
(deflayer quick-access
  _         _      _     _      _      _      _      _      _      _    _     _   _   _   _     _    _
  _         _      _     _      _      _      _      _      _      _    _     _   _   _              _
  _         _      _     @cxce  @as%   @cccvv _      _      @cccyi _    _     _   _   _              _
  _         @ead   @cs   @cccdd @cccaf _      _      _      _      _    _     _   _                  _
  _    _    _      _     _      @vv    _      @cccon _      @ccce, _    _     _       _              _
...
(deflayer handler
  ...
  _         @nv_df _    _    @sy_qs _    _    _    _    _    @ctt  _   _                  _
  _    _    _      _    _    _      _    _    _    _    _    _     _       _              _
...
(deflayer emacs
  _         _    _     _     _     _     _      _    _     _      _     _   _   _   _     _    _
  _         _    _     _     _     _     _      _    _     _      _     _   _   _              _
  _         _    @cxcs @mx   _     @cxt2 _      _    _     _      _     _   _   _              _
  _         _    _     _     @cxcf @cg   _      _    _     @cccvt @as:  _   _                  _
...
(deflayer navegation
  _         _    _    _     _    _    _      _      _      _      _     _   _   _   _     _    _
  _         _    _    _     _    _    _      _      _      _      _     _   _   _              _
  _         _    _    _     _    _    _      @cccvd @cccvu @cxo   @cxto _   _   _              _
  _         _    _    _     _    _    @ccceb @cccen @cccep @cccef _     _   _                  _
  _    _    _    _    _     _    @cx1 @cccvn @cccvm _      @cx0   _     _       _              _
  _         _    _          _         @def   _      _                       _   _   _
  )
#+end_src
