...
(use-package skeletor
  ...
  (skeletor-define-constructor "Python Kata"
    ...
    (lambda (spec)
      (let-alist spec
        (skeletor-shell-command
         (format "poetry new --name %s --src python" (shell-quote-argument .project-name))
         .project-dir)))))
#+end_src
...
#+begin_src emacs-lisp
(defun ram/elisp-create-kata ()
  (skeletor-create-project-at default-directory
                              (ram/get-skeleton "Elisp kata")))

(defun ram/elisp-fiveam-create-kata ()
  (skeletor-create-project-at default-directory
                              (ram/get-skeleton "Elisp fiveam kata")))

(defun ram/lisp-create-kata ()
  (skeletor-create-project-at default-directory
                              (ram/get-skeleton "Lisp kata")))

(defun ram/create-kata ()
  (interactive)
  (let ((project (completing-read "Choose: " '("Cpp kata with make, ut, fmt"
                                               "Dart Project"
                                               "Dcli Project"
                                               "Elisp kata"
                                               "Lisp kata"
                                               ...
                                               "Python Project"))))
    (pcase (list project)
      ('("Cpp kata with make, ut, fmt") (ram/cpp-create-project))
      ('("Dart Project") (ram/dart-create-project))
      ('("Dcli Project") (ram/dcli-create-script))
      ('("Elisp kata") (ram/elisp-create-kata))
      ('("Lisp kata") (ram/lisp-create-kata))
      ('("Lisp fiveam kata") (ram/elisp-fiveam-create-kata))
      ('("Flutter Project") (ram/flutter-create-project))
      ('("Python Project") (ram/python-create-project)))))
#+end_src
