...
(use-package lsp-mode
  ...
  :custom
  (lsp-clients-clangd-executable (concat (getenv "HOME") "/bin/clang13/bin/clangd"))
...
export LD_LIBRARY_PATH="$HOME/bin/c-libraries/lib:$HOME/bin/gcc-trunk/lib64:$HOME/bin/gcc-trunk/lib:$HOME/bin/clang13/lib:$HOME/bin/cpp-libraries/lib:$HOME/bin/graphviz/lib:$LD_LIBRARY_PATH"
...
*** Clang
#+begin_src sh
export PATH="$HOME/bin/clang13/bin:$PATH"
