...
(defalias ls-def (layer-switch default))
(defalias ls-sym (layer-switch symbols))
#+end_src

*** Layout aliases
#+begin_src lisp
(defalias
  lip (layer-switch lisp)
...
(deflayer handler
  ...
  _         _    _    _    @sym _    _    _    _    @lip @ctt  _   _                  _
  _    _    _    _    _    _    _    _    _    _    _    _     _       _              _
...
(deflayer emacs
  _         _    _    _    _    _     _    _    _     _    _     _   _   _   _     _    _
  _         _    _    _    _    _     _    _    _     _    _     _   _   _              _
  @cxto     _    _    _    _    @cxt2 _    _    _     @cx0 _     _   _   _              _
  _         _    _    _    _    _     _    @cd  @ccru _    _     _   _                  _
  _    _    _    _    _    @ccv _     _    @cx1 _     _    _     _       _              _
...
(deflayer lisp
  ...
  `           1     2    3    4    5    6    7    8    9    0    -     =      caps              home
  tab         q     w    e    r    t    y    u    i    o    p    [     ]      ret               pgup
  bspc        a     s    d    f    g    h    [    k    l    ;    '     \                        pgdn
  lsft  @ct   z     x    c    v    b    n    m    ,    .    /    rsft         up                end
  lctl        lmet  lalt      spc       @def cmps rctl                 left   down   rght
  )
#+end_src
